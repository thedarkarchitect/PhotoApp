...
//    .addConverterFactory(Json.asConverterFactory("application/json".toMediaType()))//this is the retrofit converter
//    .baseUrl(BASE_URL)
//    .build()

interface MarsApiService{//defines how retrofit talks to the web server using HTTP requests
    @GET("photos")//the string is the URL or locator withing the URI
